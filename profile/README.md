...
| [backend](https://github.com/mintcarbon/mintcarbon-backend/blob/main/README.md) | Off-chain backend services — REST API, KYC module, registry integrations, notification service, price oracle adapter, compliance reporting | Rust/Go, PostgreSQL, Redis |
| [web](https://github.com/mintcarbon/mintcarbon-web/blob/main/README.md) | Frontend web dashboard — Issuer, Trader, Compliance Officer, and Admin interfaces | React/Next.js, TypeScript, Tailwind |
