...
|------------|-------------|------------|
| [contracts](./repos/contracts/README.md) | Soroban smart contracts — token, marketplace, escrow, governance, verification records, audit log | Rust, Soroban SDK |
| [backend](./repos/backend/README.md) | Off-chain backend services — REST API, KYC module, registry integrations, notification service, price oracle adapter, compliance reporting | Rust/Go, PostgreSQL, Redis |
| [web](./repos/web/README.md) | Frontend web dashboard — Issuer, Trader, Compliance Officer, and Admin interfaces | React/Next.js, TypeScript, Tailwind |
